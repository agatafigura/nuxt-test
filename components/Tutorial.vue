...
<Header/>
<div class="bg-white">
   <nav class="pt-6" aria-label="Breadcrumb">
  ...
  <div class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
    ...
    <div class="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
      ...
      <div class="group relative">
        <div class="w-full min-h-80 bg-gray-200 aspect-w-1 aspect-h-1 rounded-md overflow-hidden group-hover:opacity-75 lg:h-80 lg:aspect-none">
          <img ref="preview" src="https://tailwindui.com/img/ecommerce-images/product-page-01-related-product-01.jpg" alt="Front of men&#039;s Basic Tee in black." class="w-full h-full object-center object-cover lg:w-full lg:h-full">
        </div>
        <div class="mt-4 flex justify-between">
          <div @click="showModal = true">
            <h3 class="text-sm text-gray-700">
      ...
      <Preview v-show="showModal" @close-modal="showModal = false"  @open-basket="showBasket = true" @read-more="showModal = false, showDetails = true"/>
    </div>
  </div>
</div>
...
export default {
  components: { Header, Preview, Basket, Details },
  name: 'NuxtTutorial',
  data() {
    return {
      showModal: false,
